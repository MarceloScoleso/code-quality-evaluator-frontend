  ...
  return (
    <div className="min-h-screen flex bg-slate-950 overflow-hidden">
      ...
      <aside className="hidden lg:flex relative w-[52%] flex-shrink-0 flex-col justify-between px-14 py-12 overflow-hidden bg-slate-950">
        ...
        {/* glow roxo */}
        <div
          className="absolute top-1/2 left-[40%] -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full pointer-events-none"
        ...
        {/* glow verde sutil — diferencia do login */}
        <div
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, transparent, rgba(139,92,246,0.4) 30%, rgba(56,189,248,0.3) 70%, transparent)",
          }}
        />
        ...
        <div className="relative z-10 flex flex-col justify-center flex-1 py-16">
          ...
          <p className="text-sm text-slate-400 leading-relaxed max-w-sm font-light">
            Crie sua conta e tenha acesso imediato à plataforma de
            classificação estratégica de projetos de software.
          </p>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full rounded-xl pl-9 pr-11 py-3 bg-white/[0.03] border border-white/[0.08] text-slate-100 text-sm placeholder:text-slate-600 outline-none transition-all duration-200 focus:border-violet-500 focus:bg-violet-500/[0.06] focus:ring-2 focus:ring-violet-500/20"
                />
                <button
                  type="button"
