...
import { Plus, BarChart2, Download, TrendingUp, Zap, Clock, FileText, UserCircle } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col bg-slate-950 text-slate-100">
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden pt-20 pb-16 px-6">
          ...
          />
          <div className="absolute -top-28 left-1/2 -translate-x-1/2 w-[700px] h-[480px] rounded-full pointer-events-none"
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            ...
            {/* ── CTAs rápidos: Dashboard + Minha Conta ── */}
            <div className="flex flex-wrap justify-center gap-3">
 
              {/* dashboard */}
              <a href="/evaluations/dashboard"
        ...
        <section className="max-w-5xl mx-auto px-6 pb-16">
          <div className="relative rounded-3xl overflow-hidden border border-slate-800/70">
            ...
            <div className="absolute inset-0 pointer-events-none opacity-40"
              style={{ backgroundImage: "radial-gradient(rgba(139,92,246,0.09) 1px, transparent 1px)", backgroundSize: "22px 22px" }} />
            <div className="absolute -top-20 left-1/2 -translate-x-1/2 w-[480px] h-[180px] rounded-full pointer-events-none"
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 px-10 py-10">
              <div className="flex-1 text-left">
                ...
                <h3 className="font-extrabold text-[clamp(1.3rem,2.5vw,1.9rem)] tracking-tight leading-snug text-white mb-3">
                  Decisões técnicas
                  <span className="block bg-gradient-to-r from-violet-400 to-sky-300 bg-clip-text text-transparent">baseadas em dados</span>
                </h3>
              ...
              <div className="flex-shrink-0 flex flex-col items-center gap-4">
                <div className="flex flex-col items-center">
                  <div className="w-[110px] h-[110px] rounded-full flex flex-col items-center justify-center"
                    style={{ border: "2px solid transparent", background: "linear-gradient(#0F172A, #0F172A) padding-box, linear-gradient(135deg, #8B5CF6, #38BDF8) border-box" }}>
